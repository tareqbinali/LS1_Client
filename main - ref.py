...
from constants import app_exe_path, version_no, release_date, icon_file , style_file, client_cert_file, client_key_file
...
class mainUI(QMainWindow):
    ...
    def enable_widgets(self, status=True):
        ...
        self.btn_Connect.setEnabled(status)
    ...
    def on_worker_finished(self):
        ...
        self.creat_spec_images=False
        print("Image population finished!")    
...
# ====================================================================================== 
    ...
    def createMenu(self): 
        ...
        open_file_action=self.menu_file.addAction("Open job list")
        open_file_action.triggered.connect(self.open_revisit_list)
        save_file_action=self.menu_file.addAction("Save job list")
        save_file_action.triggered.connect(self.save_revisit_list)

        clear_joblist_action=self.menu_file.addAction("Clear job list")
        clear_joblist_action.triggered.connect(self.clear_job_list)
        
        export_joblist_action=self.menu_file.addAction("Export job list")
        export_joblist_action.triggered.connect(self.exportJobList)

   
        

        quit_action=self.menu_file.addAction("Quit")
        ...
        update_action=self.menu_help.addAction("checkUpdate")
        ...
        self.logout_action=self.menu_login.addAction("log out")
        self.logout_action.setVisible(True)
        self.logout_action.triggered.connect(lambda: self.enable_widgets(status=False))

        self.register_action=self.menu_login.addAction('register')
        self.register_action.triggered.connect(self.show_register_dialog)
        

        # self.licence_action.triggered.connect(self.show_login_dialog)
        ...
        self.menu_bar.removeAction(self.menu_admin.menuAction())
    ...
    def createToolbar(self):
        ...
        self.btn_GridView=QPushButton("Grid View")
